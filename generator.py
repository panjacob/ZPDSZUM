...
def get_generators(dataset_name, is_create_new_dataset=True, limit_count=False):
    dataset_dir, train_dir, test_dir = create_directories_dataset(dataset_name)

    if is_create_new_dataset:
        dataset = load_dataset()
        corelated = [(1, 20), (21, 83), (84, 92), (93, 114), (115, 209), (210, 227), (228, 262), (283, 366),
                     (420, 443), (444, 465)]

        train_set, test_set = generate_datasets(dataset, corelated, 0.8, 0.2)
...
def generate_datasets(dataset, corelated, train_ratio, test_ratio):
